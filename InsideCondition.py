...
class InsideCondition:
    ...
    def light_condition(self, light_percent=None):
        ...
        if light_percent is None:  # it is not possible to refer to self in default value because instance not created
    ...
    #  --------- internal ---------------------------------------------------
    @staticmethod
    def _filteredVoltage(maxDelta, measure, interval=CST.LM35_INTERVAL):
